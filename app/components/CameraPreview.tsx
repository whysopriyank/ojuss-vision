    ...
    <div className="space-y-4 w-full">
      <div className="relative w-full bg-zinc-100 rounded-lg overflow-hidden">
        <video
          ...
          autoPlay
          playsInline
          className="w-full aspect-video object-cover bg-zinc-100 rounded-lg"
          ...
          <div className="absolute inset-0 bg-black/50 flex items-center justify-center rounded-lg backdrop-blur-sm">
            <div className="text-center space-y-2">
              ...
              <p className="text-white font-medium">
                {connectionStatus === 'connecting' ? 'Connecting to Ojuss...' : 'Disconnected'}
              </p>
        ...
        {!isStreaming && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center space-y-3">
              ...
              <p className="text-zinc-600 font-medium">Camera is off</p>
              <p className="text-zinc-500 text-sm">Click the button below to start</p>
            </div>
          </div>
        )}
